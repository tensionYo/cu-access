...
def head_user_list(department, station, dt, k):
    """
    :type department: str
    :type station: str
    :type dt: str
    ...
    :return:
    """
    r = get_top_k_aaa_user(department, station, dt, k)
    res = {
        'upstream': format_user_list(r['upstream']['list']),
        'downstream': format_user_list(r['downstream']['list']),
        'upstream_count': count_by_speed(r['upstream']['list']),
        'downstream_count': count_by_speed(r['downstream']['list'])
    }
    return res
